...
(function () {
  ...
  // --- DEFAULT MASTER DATA (Dwi & Deni) ---
  const DEFAULT_DATA = {
    slug: 'dwi-deni',
    brideName: 'Dwi',
    brideFullName: 'Dwi',
    brideParents: 'Putri dari Bapak Herman Pratiwi & Ibu Susanti',
    bridePhotoUrl: 'assets/uploads/file_1788946917363_599ah.jpg',
    brideInstagram: '@dwi',
    groomName: 'Deni',
    groomFullName: 'Deni',
    groomParents: 'Putra dari Bapak Nugroho Wibowo & Ibu Ratna Dewi',
    groomPhotoUrl: 'assets/uploads/file_1788946914132_yffog.jpg',
    groomInstagram: '@deni',
    ...
    akadVenue: 'Rumah Mempelai Putri',
    mapUrlAkad: 'https://maps.google.com',
    resepsiTime: '13:00 - Selesai',
    resepsiVenue: 'Rumah Mempelai Putri',
    ...
    musicUrl: '',
    timeline: [
      { year: '2021', title: 'Pertemuan Pertama', text: 'Takdir mempertemukan kami pertama kali di lingkungan kampus saat berada dalam satu kelompok proyek desain bersama.' },
      { year: '2023', title: 'Menjalin Hubungan', text: 'Dari pertemanan hangat, kami menyadari adanya keselarasan visi hidup dan sepakat untuk melangkah ke jenjang yang lebih serius.' },
      { year: '2025', title: 'Hari Lamaran', text: 'Dengan restu kedua orang tua dan keluarga besar, kami meresmikan niat tulus melalui ikatan pertunangan yang khidmat.' },
      { year: '2026', title: 'Menuju Pelaminan', text: 'Insya Allah kami akan mengikrarkan akad suci pernikahan, melangkah bersama membina keluarga yang penuh sakinah dan kasih sayang.' }
    ],
  ...
  // Kamus Klien Bawaan (Memastikan data langsung tampil di static hosting/Cloudflare tanpa perlu file .json terpisah)
  const EMBEDDED_CLIENTS = {
    'dwi-deni': DEFAULT_DATA,
    'deni-dwi': DEFAULT_DATA,
    'kirana-bayu': {
      slug: 'kirana-bayu',
      brideName: 'Kirana',
      ...
      musicUrl: '',
      timeline: [
        { year: '2019', title: 'Perkenalan', text: 'Bertemu pertama kali di acara kampus.' },
        { year: '2021', title: 'Lebih Dekat', text: 'Menjadi pasangan saling mendukung.' },
        { year: '2026', title: 'Menuju Pernikahan', text: 'Melangkah ke jenjang yang lebih serius.' }
      ],
      bankName1: 'Bank Mandiri',
      bankNum1: '1234567890',
  ...
  async function loadInvitation(id, guest) {
    ...
    // 2. Fallback: Embedded Clients jika static JSON tidak ada di hosting
    if (!data && id && EMBEDDED_CLIENTS[id]) {
      data = Object.assign({}, EMBEDDED_CLIENTS[id]);
    }

    // 2b. Fallback: LocalStorage spesifik slug
    if (!data && id && id !== 'demo') {
  ...
  async function showUserDashboard(clientSlug) {
    ...
    // Fallback: Embedded Clients
    if (!data && requestedSlug && EMBEDDED_CLIENTS[requestedSlug]) {
      data = Object.assign({}, EMBEDDED_CLIENTS[requestedSlug]);
    }
